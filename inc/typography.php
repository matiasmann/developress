...
if ( ! function_exists( 'develope_enqueue_google_fonts' ) ) {
	add_action( 'wp_enqueue_scripts', 'develope_enqueue_google_fonts', 0 );
	/**
	 * Add Google Fonts to wp_head if needed.
	 *
	 * @since 0.1
	 */
	function develope_enqueue_google_fonts() {
		...
		if ( ! empty( $font_settings ) ) {
			...
			foreach ( $font_settings as $key ) {
				...
				if ( ! isset( $develope_settings[ $key ] ) ) {
					continue;
				}

				// If our value is still using the old format, fix it
				if ( strpos( $develope_settings[ $key ], ':' ) !== false ) {
					$develope_settings[ $key ] = current( explode( ':', $develope_settings[ $key ] ) );
				}

				// Replace the spaces in the names with a plus
				$value = str_replace( ' ', '+', $develope_settings[ $key ] );

				// Grab the variants using the plain name
				$variants = develope_get_google_font_variants( $develope_settings[ $key ], $key );
		...
		$google_fonts = apply_filters( 'develope_typography_google_fonts', $google_fonts );

		// Get the subset
		$subset = apply_filters( 'develope_fonts_subset','' );
		...
		$display = apply_filters( 'develope_google_font_display', '' );
		...
		// Enqueue our fonts
		if ( $google_fonts ) {
			wp_enqueue_style( 'develope-fonts', $fonts_url, array(), null, 'all' );
		}
	}
}

if ( ! function_exists( 'develope_default_fonts_customize_register' ) ) {
	add_action( 'customize_register', 'develope_default_fonts_customize_register' );
	/**
	 * Build our Typography options
	 *
	 * @since 0.1
	 */
	function develope_default_fonts_customize_register( $wp_customize ) {
		if ( function_exists( 'develope_fonts_customize_register' ) ) {
			// Bail if DP Premium is active
			return;
		}
		...
		$wp_customize->add_section(
			'font_section',
			array(
				'title' => __( 'Typography', 'developress' ),
		...
		$wp_customize->add_setting(
			...
			array(
				...
				'sanitize_callback' => 'develope_sanitize_variants',
			)
		);

		$wp_customize->add_setting(
			'develope_settings[body_font_weight]',
			array(
		...
		$wp_customize->add_setting(
			'develope_settings[body_font_transform]',
			array(
		...
		$wp_customize->add_control(
			new Develope_Typography_Customize_Control(
				$wp_customize,
				'body_typography',
				array(
					'label' => __( 'Body', 'developress' ),
					'section' => 'font_section',
					'priority' => 1,
					'settings' => array(
						'family' => 'develope_settings[font_body]',
						'variant' => 'font_body_variants',
						'category' => 'font_body_category',
						'weight' => 'develope_settings[body_font_weight]',
						'transform' => 'develope_settings[body_font_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_setting(
			'develope_settings[body_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Develope_Range_Slider_Control(
				...
				array(
					...
					'description' => __( 'Font size', 'developress' ),
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'develope_settings[body_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 6,
		...
		$wp_customize->add_setting(
			'develope_settings[body_line_height]',
			array(
				'default' => $defaults['body_line_height'],
				'type' => 'option',
				'sanitize_callback' => 'develope_sanitize_decimal_integer',
				'transport' => 'postMessage',
			)
		);
		...
		$wp_customize->add_control(
			new Develope_Range_Slider_Control(
				...
				array(
					'type' => 'developress-range-slider',
					'description' => __( 'Line height', 'developress' ),
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'develope_settings[body_line_height]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 1,
		...
		$wp_customize->add_setting(
			'develope_settings[paragraph_margin]',
			array(
		...
		$wp_customize->add_control(
			new Develope_Range_Slider_Control(
				...
				array(
					'type' => 'developress-range-slider',
					'description' => __( 'Paragraph margin', 'developress' ),
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'develope_settings[paragraph_margin]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 0,
		...
		$wp_customize->add_setting(
			'develope_settings[font_heading_1]',
			array(
		...
		$wp_customize->add_setting(
			'develope_settings[heading_1_weight]',
			array(
		...
		$wp_customize->add_setting(
			'develope_settings[heading_1_transform]',
			array(
		...
		$wp_customize->add_control(
			new Develope_Typography_Customize_Control(
				...
				array(
					'label' => __( 'Heading 1 (H1)', 'developress' ),
					'section' => 'font_section',
					'settings' => array(
						'family' => 'develope_settings[font_heading_1]',
						'variant' => 'font_heading_1_variants',
						'category' => 'font_heading_1_category',
						'weight' => 'develope_settings[heading_1_weight]',
						'transform' => 'develope_settings[heading_1_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_setting(
			'develope_settings[heading_1_font_size]',
			array(
		...
		$wp_customize->add_setting(
			'develope_settings[mobile_heading_1_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Develope_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'develope_settings[heading_1_font_size]',
						'mobile' => 'develope_settings[mobile_heading_1_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 15,
		...
		$wp_customize->add_setting(
			'develope_settings[heading_1_line_height]',
			array(
		...
		$wp_customize->add_control(
			new Develope_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'develope_settings[heading_1_line_height]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 0,
		...
		$wp_customize->add_setting(
			'develope_settings[font_heading_2]',
			array(
		...
		$wp_customize->add_setting(
			'develope_settings[heading_2_weight]',
			array(
		...
		$wp_customize->add_setting(
			'develope_settings[heading_2_transform]',
			array(
		...
		$wp_customize->add_control(
			new Develope_Typography_Customize_Control(
				...
				array(
					'label' => __( 'Heading 2 (H2)', 'developress' ),
					'section' => 'font_section',
					'settings' => array(
						'family' => 'develope_settings[font_heading_2]',
						'variant' => 'font_heading_2_variants',
						'category' => 'font_heading_2_category',
						'weight' => 'develope_settings[heading_2_weight]',
						'transform' => 'develope_settings[heading_2_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_setting(
			'develope_settings[heading_2_font_size]',
			array(
		...
		$wp_customize->add_setting(
			'develope_settings[mobile_heading_2_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Develope_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'develope_settings[heading_2_font_size]',
						'mobile' => 'develope_settings[mobile_heading_2_font_size]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 10,
		...
		$wp_customize->add_setting(
			'develope_settings[heading_2_line_height]',
			array(
		...
		$wp_customize->add_control(
			new Develope_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'develope_settings[heading_2_line_height]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 0,
		...
		$wp_customize->add_setting(
			'develope_settings[font_heading_3]',
			array(
		...
		$wp_customize->add_setting(
			'develope_settings[heading_3_weight]',
			array(
		...
		$wp_customize->add_setting(
			'develope_settings[heading_3_transform]',
			array(
		...
		$wp_customize->add_control(
			new Develope_Typography_Customize_Control(
				...
				array(
					'label' => __( 'Heading 3 (H3)', 'developress' ),
					'section' => 'font_section',
					'settings' => array(
						'family' => 'develope_settings[font_heading_3]',
						'variant' => 'font_heading_3_variants',
						'category' => 'font_heading_3_category',
						'weight' => 'develope_settings[heading_3_weight]',
						'transform' => 'develope_settings[heading_3_transform]',
					),
				)
			)
		);
		...
		$wp_customize->add_setting(
			'develope_settings[heading_3_font_size]',
			array(
		...
		$wp_customize->add_control(
			new Develope_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'develope_settings[heading_3_font_size]'
					),
					'choices' => array(
						'desktop' => array(
							'min' => 10,
		...
		$wp_customize->add_setting(
			'develope_settings[heading_3_line_height]',
			array(
		...
		$wp_customize->add_control(
			new Develope_Range_Slider_Control(
				...
				array(
					...
					'section' => 'font_section',
					'settings' => array(
						'desktop' => 'develope_settings[heading_3_line_height]',
					),
					'choices' => array(
						'desktop' => array(
							'min' => 0,
		...
		if ( ! function_exists( 'develope_fonts_customize_register' ) && ! defined( 'DP_PREMIUM_VERSION' ) ) {
			$wp_customize->add_control(
...
if ( ! function_exists( 'develope_get_all_google_fonts' ) ) {
	/**
	 ...
	 */
	function develope_get_all_google_fonts( $amount = 'all' ) {
		...
		if ( apply_filters( 'develope_alphabetize_google_fonts', true ) ) {
			asort( $fonts );
		}

		// Filter to allow us to modify the fonts array
		return apply_filters( 'develope_google_fonts_array', $fonts );
	}
}

if ( ! function_exists( 'develope_get_all_google_fonts_ajax' ) ) {
	add_action( 'wp_ajax_develope_get_all_google_fonts_ajax', 'develope_get_all_google_fonts_ajax' );
	/**
	 * Return an array of all of our Google Fonts.
	 *
	 * @since 1.3.0
	 */
	function develope_get_all_google_fonts_ajax() {
		// Bail if the nonce doesn't check out
		if ( ! isset( $_POST['dp_customize_nonce'] ) || ! wp_verify_nonce( sanitize_key( $_POST['dp_customize_nonce'] ), 'dp_customize_nonce' ) ) {
			wp_die();
		}

		// Do another nonce check
		check_ajax_referer( 'dp_customize_nonce', 'dp_customize_nonce' );
...
if ( ! function_exists( 'develope_get_google_font_variants' ) ) {
	/**
	 * Wrapper function to find variants for chosen Google Fonts
	 * Example: develope_get_google_font_variation( 'Open Sans' )
	 * @since 1.3.0
	 */
	function develope_get_google_font_variants( $font, $key = '' ) {
		...
		if ( $variants ) {
			...
			return implode( ',', apply_filters( 'develope_typography_variants', $output ) );
		}
	}
}

if ( ! function_exists( 'develope_get_google_font_category' ) ) {
	/**
	 * Wrapper function to find the category for chosen Google Font
	 * Example: develope_get_google_font_category( 'Open Sans' )
	 *
	 * @since 1.3.0
	 *
...
if ( ! function_exists( 'develope_get_font_family_css' ) ) {
	/**
	 ...
	 */
	function develope_get_font_family_css( $font, $settings, $default ) {
		$develope_settings = wp_parse_args(
		...
		$no_quotes = array(
			...
			apply_filters( 'develope_typography_system_stack', '-apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"' ),
		);

		// Get our font
		$font_family = $develope_settings[ $font ];

		if ( 'System Stack' == $font_family ) {
			$font_family = apply_filters( 'develope_typography_system_stack', '-apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"' );
		}
		...
		if ( in_array( $font_family, $no_quotes ) ) {
			...
			$wrapper_start = '"';
			$wrapper_end = '"' . develope_get_google_font_category( $font_family, $font );
		}
...
if ( ! function_exists( 'develope_add_to_font_customizer_list' ) ) {
	add_filter( 'develope_typography_customize_list', 'develope_add_to_font_customizer_list' );
	/**
	...
	function develope_add_to_font_customizer_list( $fonts ) {
		...
		$all_fonts = develope_get_all_google_fonts();
		$select_fonts = develope_get_all_google_fonts( apply_filters( 'develope_number_of_fonts', 200 ) );

		foreach ( $font_settings as $setting ) {
			// If we don't have a setting, keep going
			if ( ! isset( $develope_settings[ $setting ] ) ) {
				continue;
			}
			...
			$fonts[ strtolower( str_replace( ' ', '_', $develope_settings[ $setting ] ) ) ] = array(
				'name' => $develope_settings[ $setting ],
